...
<head>
    ...
    <link rel="stylesheet" href="EditPerfilT.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form method="POST" action="..\Acciones\agregardatostrabajador.php" class="signup-form">
                ...
                $mostrardatos = 'SELECT * FROM Trabajadores WHERE TrabajadorId LIKE "' . $usuarioid . '" ';
                ...
                <div class="form-textbox">
                    ...
                    <input type="text" name="username" id="username" disabled placeholder="<?php echo $info["UsuarioT"] ?>" />
                </div>
                ...
                <div class="form-textbox">
                    <label for="text">Nombre <i class="fas fa-user"></i> </label>
                    <input type="text" name="nombre" id="nombre" placeholder="<?php
                        echo $info["NombreTrabajador"]?>"/>
                </div>

                <div class="form-textbox">
                    <label for="telefono">Teléfono <i class="fas fa-phone"></i> </label>
                    <input type="phone" name="telefono" id="telefono" placeholder="<?php echo $info["Telefono"] ?>" />
                </div>

                <div class="line"></div>

                <h3 class="titulos">Disponibilidad en la semana</h3>
                ...
                <div class="container dias">
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\LUNES.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Lunes" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\MARTES.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Martes" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\MIERCOLES.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Miercoles" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\JUEVES.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Jueves" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\VIERNES.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Viernes" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\SABADO.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Sabado" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                        <label class="image-checkbox">
                            <img class="img-responsive calendario" src=..\imagenes\DOMINGO.png />
                            <input type="checkbox" name="dia[]" id="dia" value="Domingo" />
                            <i class="fa fa-check hidden"></i>
                        </label>
                    </div>
                ...
                <h3 class="titulos">Seleccione en que barrios puede trabajar</h3>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h3 class="titulos" id="of" >Seleccione los oficios que realiza</h3>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3 col-sm-5">
                                    <p> <input id="a" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Albañilería"><label class="css-label" for="a">Albañilería</label> </p>
                                    <p> <input id="b" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Carpintería"><label class="css-label" for="b">Carpintería</label> </p>
                                    <p> <input id="c" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Diseño"><label class="css-label" for="c">Diseño</label> </p>
                                    <p> <input id="d" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Electricidad"><label class="css-label" for="d">Electricidad</label> </p>
                                </div>

                                <div class="col-md-3 col-sm-5">
                                    <p> <input id="e" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Personal Doméstico"><label class="css-label" for="e">Personal Doméstico</label> </p>
                                    <p> <input id="f" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Fotografía"><label class="css-label" for="f">Fotografía</label> </p>
                                    <p> <input id="g" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Gas"><label class="css-label" for="g">Gas</label> </p>
                                    <p> <input id="h" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Herrería"><label class="css-label" for="h">Herrería</label> </p>
                                </div>

                                <div class="col-md-3 col-sm-5">
                                    <p> <input id="i" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Enfermería"><label class="css-label" for="i">Enfermería</label> </p>
                                    <p> <input id="j" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Manualidades"><label class="css-label" for="j">Manualidades</label> </p>
                                    <p> <input id="k" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Plomería"><label class="css-label" for="k">Plomería</label> </p>
                                    <p> <input id="l" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Servicio Técnico"><label class="css-label" for="l">Servicio Técnico</label> </p>
                                </div>

                                <div class="col-md-3 col-sm-5">
                                    <p> <input id="m" id="profesion" name="profesion[]" type="checkbox" class="css-checkbox" value="Docencia"><label class="css-label" for="m">Docencia</label> </p>
                                </div>
                            </div>
                        </div>
    ...
    <script src="EditPerfilT.js"></script>
