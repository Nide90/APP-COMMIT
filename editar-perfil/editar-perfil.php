...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h3>Disponibilidad en la semana</h3>
            ...
            <h3>Seleccione en que barrios puede trabajar</h3>
            ...
            <h3>Seleccione los oficios que realiza</h3>

            <br>

            <div class="checkbox">
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Albañilería
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Carpintería
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Diseño
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value="">
                        Electricidad </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Personal
                        Doméstico </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Fotografía
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Gas
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Herrería
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Limpieza
                    </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value="">
                        Manualidades </label></div>
                <div class="elementos"><label class="check"><input type="checkbox" class="oficios" value=""> Plomería
                    </label></div>
            </div>
